...
const Home = () => {
  return (
    <div className="w-full  font-segoe flex flex-col lg:flex-row md:items-center md:justify-center overflow-hidden lg:gap-0 text-white">
      {/* Left Section */}
      <div className="w-full lg:w-2/3 flex items-start md:justify-center flex-col bg-[#AEBD48] py-6 px-8 md:px-12 lg:px-16 h-full lg:h-auto">
      ...
      {/* Right Section */}
      <div className="w-full lg:w-1/3 lg:bg-white bg-[#AEBD48] px-8 md:px-16  lg:py-0 lg:px-0 lg:relative flex justify-center items-center lg:justify-end h-auto lg:h-full">
        <img
          className="w-80 h-80 md:w-72 lg:w-96 lg:h-96 xl:w-[420px] xl:h-[420px] lg:absolute lg:-left-24 xl:-left-36 object-contain"
          src={homeimg}
          alt="Medisuite"
        />
      </div>
